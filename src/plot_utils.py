...
def display_confusion_matrix(cm, title):
    """
    Display a normalized confusion matrix as percentages.
    """
...
def plot_misclassified_images(misclassified_indices, x_test, y_test, model_pred, title):
    """
    Plot the first 10 misclassified images with their true and predicted labels.
    """
...
def plot_training_graphs(history, model_name, title):
    """
    Plot training and validation accuracy/loss curves from a history dictionary.
    """
...
# Optional: test code only runs if you execute this file directly
if __name__ == "__main__":
    print("helpers.py loaded successfully — run tests here if needed.")
